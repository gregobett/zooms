<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3">
    ...
    <x-sidebar.dropdown title="Profile" :active="Str::startsWith(request()->route()->uri(), 'buttons' )  ">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 
                0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
        </x-slot>
        @if((Route::is('add-student')) || (Route::is('register-grade1')) || (Route::is('register-grade2')) || 
        (Route::is('register-grade3')) || (Route::is('register-grade4')) || (Route::is('register-grade-senior1')) || 
    ...
    <x-sidebar.dropdown title="Grades" :active="Str::startsWith(request()->route()->uri(), 'buttons' )  ">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 
                2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 
                3.375M9 15l2.25 2.25L15 12" />
            </svg>
        </x-slot>
        @if((Route::is('add-student')) || (Route::is('register-grade1')) || (Route::is('register-grade2')) || 
        (Route::is('register-grade3')) || (Route::is('register-grade4')) || (Route::is('register-grade-senior1')) || 
    ...
    <x-sidebar.dropdown title="Announcement" :active="Str::startsWith(request()->route()->uri(), 'buttons' )  ">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" 
                stroke-linejoin="round" 
                d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 
                9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 
                20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 
                0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 
                0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 
                1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" />
            </svg>
        </x-slot>
        @if((Route::is('add-student')) || (Route::is('register-grade1')) || (Route::is('register-grade2')) || 
        (Route::is('register-grade3')) || (Route::is('register-grade4')) || (Route::is('register-grade-senior1')) || 
    ...
    <x-sidebar.dropdown title="Mail" :active="Str::startsWith(request()->route()->uri(), 'buttons' )  ">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 
    ...
    <x-sidebar.dropdown title="Todo" :active="Str::startsWith(request()->route()->uri(), 'buttons' )  ">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" 
                stroke-linejoin="round" 
        ...
        (Route::is('register-grade3')) || (Route::is('register-grade4')) || (Route::is('register-grade-senior1')) || 
        (Route::is('register-grade-senior2')) || (Route::is('register-grade-senior3')) || (Route::is('register-grade-senior4')))
            <x-sidebar.link title="Todo " href='#' />
        @else
            <x-sidebar.link title="Make Todos " href='/student-todo' />
        @endif
    </x-sidebar.dropdown>
    ...
    <x-sidebar.dropdown title="Profile" :active="Str::startsWith(request()->route()->uri(), 'buttons')">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 
    ...
    <x-sidebar.dropdown title="Students" :active="Str::startsWith(request()->route()->uri(), 'buttons')">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 
                6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 
                2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 
                0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
            </svg>
        </x-slot>
    ...
    <x-sidebar.dropdown title="Todos" :active="Str::startsWith(request()->route()->uri(), 'buttons' )">
        <x-slot name="icon">
            ...
            <x-sidebar.link title="Create Todos " href='/faculty-todo' />
    </x-sidebar.dropdown>
