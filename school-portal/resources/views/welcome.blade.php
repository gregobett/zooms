...
<div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="w-full xl:w-3/5  lg:w-4/5 lg:items-center mx-auto p-12 overflow-hidden">
          <img class="mx-auto w-full md:w-4/5  transform -rotate-6  transition hover:scale-105 duration-700 ease-in-out hover:rotate-6 opacity-85" src="images/macbook.webp" />
        </div>
