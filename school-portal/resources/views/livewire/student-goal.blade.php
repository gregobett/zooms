		...
		<div class="container mx-auto text-center xl:text-start text-white">
			<div class="flex flex-col xl:flex-row items-center">
				<div class="w-full flex-col xl:w-1/2">
					<h1 class="flex items-center xl:items-start text-xl lg:text-3xl font-medium mb-6  pl-4 pr-4">Steps to Successfully Complete Your Studies: A Guide to Achieving Your Educational Goals</h1>
					<p class="text-xs mb-12 lg:text-lg pl-4 pr-4">By following these steps and maintaining a disciplined approach, you can successfully complete your studies and achieve your educational goals.</p>
...
<section class="max-w-5xl mx-auto py-10">
   <div>
      ...
      <div class="flex flex-row">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded mr-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 5</div>
      ...
      <div class="flex flex-row-reverse">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded ml-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 6</div>
      ...
      <div class="flex flex-row">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded mr-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 7</div>
      ...
      <div class="flex flex-row-reverse">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded ml-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 8</div>
      ...
      <div class="flex flex-row">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded mr-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 9</div>
      ...
      <div class="flex flex-row-reverse">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded ml-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 10</div>
      ...
      <div class="flex flex-row">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded mr-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 11</div>
      ...
      <div class="flex flex-row-reverse">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded ml-4 uppercase flex flex-col items-center justify-center">
               <div class=" md:text-2xl lg:text-3xl font-black text-gray-500">Step 12</div>
      ...
      <div class="flex flex-row">
         <div class="hidden md:flex flex-col items-center">
            <div class="w-32 py-5 border border-gray-300 rounded mr-4 uppercase flex flex-col items-center justify-center">
               <div class="text-xl md:text-2xl lg:text-3xl font-black text-gray-500">Step 13</div>
         ...
         <div class="flex-auto border rounded  border-gray-300">
            <div class="flex lg:flex-row flex-col items-center">
               <div class="flex-auto">
                  ...
                  <div class="p-3 text-xl md:text-2xl lg:text-3xl text-gray-800 dark:text-gray-500 font">Graduation requirements</div>
