  ...
  <div class="p-4 w-full">
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4 shadow-xl">
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4 shadow-xl">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Total Male Students</div>
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4 shadow-xl">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Total Female Students</div>
