...
<div class="flex items-center shadow xl:ml-64 xl:mr-64 ">

<div class="bg-white rounded shadow p-6 m-4 w-full dark:bg-gray-800 ">
    <h1 class="flex text-grey-darkest text-3xl mb-8 font-bold text-center">TODO LIST</h1>
            ...
            @foreach($todos as $todo)
                <li  wire:key="{{ $todo->id }}">
                    <div class="flex mt-4"> 
                        ...
                        <div class=" p2 w-full shadow-md pl-2">
                        ...
                        <div>
                            <button class="flex-no-shrink p-2 ml-2 shadow-md border-2 rounded-lg text-white border-red bg-red-800 hover:text-white hover:bg-red-900" wire:click="delete({{ $todo->id }})">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
