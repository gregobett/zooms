      ...
      <form action="{{url('update-secondquarter')}}" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" value="{{ $data->user_id }}" name="user_id" />
          ...
          <div class="flex flex-col mb-2">
              ...
              <input value="{{$data->mothertongue2}}" class="border py-0 px-3 text-black" type="text" name="mothertongue2" id="mothertongue2" >
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="filipino2">Filipino</label>
              <input value="{{$data->filipino2}}" class="border py-0 px-3 text-black" type="text" name="filipino2" id="filipino2">
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="english2">English</label>
              <input value="{{$data->english2}}" class="border py-0 px-3 text-black" type="text" name="english2" id="english2">
          </div>
          <div class="flex flex-col mb-2">
              <label class=" text-sm text-gray-900" for="mathematics2">Mathematics</label>
              <input value="{{$data->mathematics2}}" class="border py-0 px-3 text-black" type="text" name="mathematics2" id="mathematics2">
          </div>
          <div class="flex flex-col mb-2">
              <label class="text-sm text-gray-900" for="science2">Science</label>
              <input value="{{$data->science2}}" class="border py-0 px-3 text-black" type="text" name="science2" id="science2">
          </div>

          <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="ap2">Araling Panlipunan</label>
            <input value="{{$data->ap2}}" class="border py-0 px-3 text-black" type="text" name="ap2" id="ap2">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="esp2">Edukasyon sa Pagpapalkatao</label>
            <input value="{{$data->esp2}}" class="border py-0 px-3 text-black" type="text" name="esp2" id="esp2">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="music2">Music</label>
            <input value="{{$data->music2}}" class="border py-0 px-3 text-black" type="text" name="music2" id="music2">
        </div>
        <div class="flex flex-col mb-2">
            <label class=" text-sm text-gray-900" for="arts2">Arts</label>
            <input value="{{$data->arts2}}" class="border py-0 px-3 text-black" type="text" name="arts2" id="arts2">
        </div>
        <div class="flex flex-col mb-2">
            <label class="text-sm text-gray-900" for="pe2">Physical Educataion</label>
            <input value="{{$data->pe2}}" class="border py-0 px-3 text-black" type="text" name="pe2" id="pe2">
        </div>

        <div class="flex flex-col mb-2">
          <label class="  text-sm text-gray-900" for="health2">Health</label>
          <input value="{{$data->health2}}" class="border py-0 px-3 text-black" type="text" name="health2" id="health2">
      </div>
      <div class="flex flex-col mb-2">
          <label class=" text-sm text-gray-900" for="epp2">Edukasyon Pantahanan at Pangkabuhayan</label>
          <input value="{{$data->epp2}}" class="border py-0 px-3 text-black" type="text" name="epp2" id="epp2">
      </div>
      <div class="flex flex-col mb-2">
          <label class="text-sm text-gray-900" for="tle2">Technology and Livelihood Education</label>
          <input value="{{$data->tle2}}" class="border py-0 px-3 text-black mb-2" type="text" name="tle2" id="tle2">
      </div>
