      ...
      <form action="{{url('update-firstquarter-senior')}}" method="post" enctype="multipart/form-data" id="my-form">
        ...
        <input type="hidden" value="{{ $data->user_id }}" name="user_id" />
          ...
          <div class="flex  mb-4 shadow-lg">
              ...
              <input value="{{$data->oral}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="oral" id="oral" >
          </div>
          ...
          <div class="flex  mb-4 shadow-lg">
              ...
              <input value="{{$data->reading}}" class="border py-0  w-24 dark:bg-gray-800" type="text" name="reading" id="reading">
          </div>
          ...
          <div class="flex  mb-4 shadow-lg">
              ...
              <input value="{{$data->komunikasyon}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="komunikasyon" id="komunikasyon">
          </div>
          ...
          <div class="flex mb-4 shadow-lg">
              ...
              <input value="{{$data->pagbasa}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="pagbasa" id="pagbasa">
          </div>
          ...
          <div class="flex  mb-4 shadow-lg">
              ...
              <input value="{{$data->century}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="century" id="century">
          </div>
          ...
          <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->contemporary}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="contemporary" id="contemporary">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->media}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="media" id="media">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->math}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="math" id="math">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->statistics}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="statistics" id="statistics">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->earth}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="earth" id="earth">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->philosophy}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="philosophy" id="philosophy">
        </div>
        ...
        <div class="flex  mb-4 shadow-lg">
            ...
            <input value="{{$data->culture}}" class="border py-0 w-24 dark:bg-gray-800" type="text" name="culture" id="culture">
        </div>
