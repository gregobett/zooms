      ...
      <form action="{{url('update-thirdquarter-senior')}}" method="post" enctype="multipart/form-data" id="my-form">
        ...
        <input type="hidden" value="{{ $data->user_id }}" name="user_id" />
          <div class="flex flex-col mb-2">
              ...
              <input value="{{$data->oral}}" class="border py-0 px-3 text-grey-800" type="text" name="oral3" id="oral3" >
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="reading3">Reading and Writing</label>
              <input value="{{$data->reading}}" class="border py-0 px-3 text-grey-800" type="text" name="reading3" id="reading3">
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="komunikasyon3">Komunikasyon at Pananaliksik sa Wika at Kulturang Pilipino</label>
              <input value="{{$data->komunikasyon}}" class="border py-0 px-3 text-grey-800" type="text" name="komunikasyon3" id="komunikasyon3">
          </div>
          <div class="flex flex-col mb-2">
              <label class=" text-sm text-gray-900" for="pagbasa3">Pagbasa at Pagsusuri ng Iba't-Ibang Teksto Tungo sa Pananaliksik</label>
              <input value="{{$data->pagbasa}}" class="border py-0 px-3 text-grey-800" type="text" name="pagbasa3" id="pagbasa3">
          </div>
          <div class="flex flex-col mb-2">
              <label class="text-sm text-gray-900" for="century3">21st Century Literature from the Philippines and the World</label>
              <input value="{{$data->century}}" class="border py-0 px-3 text-grey-800" type="text" name="century3" id="century3">
          </div>

          <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="contemporary3">Contemporary Philippine Arts from the Regions</label>
            <input value="{{$data->contemporary}}" class="border py-0 px-3 text-grey-800" type="text" name="contemporary3" id="contemporary3">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="media3">Media and Information Literacy</label>
            <input value="{{$data->media}}" class="border py-0 px-3 text-grey-800" type="text" name="media3" id="media3">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="math3">General Math</label>
            <input value="{{$data->math}}" class="border py-0 px-3 text-grey-800" type="text" name="math3" id="math3">
        </div>
        <div class="flex flex-col mb-2">
            <label class=" text-sm text-gray-900" for="statistics3">Statistics and Probability</label>
            <input value="{{$data->statistics}}" class="border py-0 px-3 text-grey-800" type="text" name="statistics3" id="statistics3">
        </div>
        <div class="flex flex-col mb-2">
            <label class="text-sm text-gray-900" for="earth3">Earth and Life Science</label>
            <input value="{{$data->earth}}" class="border py-0 px-3 text-grey-800" type="text" name="earth3" id="earth3">
        </div>

        <div class="flex flex-col mb-2">
          <label class="  text-sm text-gray-900" for="science3">Physical Science</label>
          <input value="{{$data->science}}" class="border py-0 px-3 text-grey-800" type="text" name="science3" id="science3">
      </div>
      <div class="flex flex-col mb-2">
          <label class=" text-sm text-gray-900" for="philosophy3">Introduction to the Philosophy of the Human Person</label>
          <input value="{{$data->philosophy}}" class="border py-0 px-3 text-grey-800" type="text" name="philosophy3" id="philosophy3">
      </div>
      <div class="flex flex-col mb-2">
          <label class="text-sm text-gray-900" for="health3">Physical Education and Health</label>
          <input value="{{$data->health}}" class="border py-0 px-3 text-grey-800 mb-2" type="text" name="health3" id="health3">
      </div>
      <div class="flex flex-col mb-2">
        <label class="text-sm text-gray-900" for="personal3">Personal Development</label>
        <input value="{{$data->personal}}" class="border py-0 px-3 text-grey-800 mb-2" type="text" name="personal3" id="persoanl3">
    </div>
    <div class="flex flex-col mb-2">
        <label class="text-sm text-gray-900" for="culture3">Understanding Culture, Society and Politics</label>
        <input value="{{$data->culture}}" class="border py-0 px-3 text-grey-800 mb-2" type="text" name="culture3" id="culture3">
    </div>
