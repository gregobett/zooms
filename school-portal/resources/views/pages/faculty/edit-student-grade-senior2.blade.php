      ...
      <form action="{{url('update-secondquarter-senior')}}" method="post" enctype="multipart/form-data" id="my-form">
        ...
        <input type="hidden" value="{{ $data->user_id }}" name="user_id" />
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->oral2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="oral2" id="oral2" >
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->reading2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="reading2" id="reading2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->komunikasyon2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="komunikasyon2" id="komunikasyon2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->pagbasa2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="pagbasa2" id="pagbasa2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->century2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="century2" id="century2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->contemporary2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="contemporary2" id="contemporary2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->media2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="media2" id="media2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->math2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="math2" id="math2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->statistics2}}" class="border py-0 w-24 dark:bg-gray-800  text-grey-800" type="text" name="statistics2" id="statistics2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->earth2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800" type="text" name="earth2" id="earth2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->science2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800" type="text" name="science2" id="science2">
             </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->philosophy2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800" type="text" name="philosophy2" id="philosophy2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->health2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800" type="text" name="health2" id="health2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->personal2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800 " type="text" name="personal2" id="persoanl2">
            </div>
            ...
            <div class="flex  mb-4 shadow-lg">
                ...
                <input value="{{$data->culture2}}" class="border py-0 w-24 dark:bg-gray-800 text-grey-800 " type="text" name="culture2" id="culture2">
            </div>
