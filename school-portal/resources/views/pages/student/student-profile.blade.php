        ...
        <div class="px-4 pt-4">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 xl:flex-row xl:space-x-4">
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->religion}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 md:mb-4 focus:outline-none focus:shadow-outline dark:bg-gray-400 focus:border-blue-200 uppercase" id="religion" name="religion">
                    @error('religion')
