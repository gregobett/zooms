        ...
        <div class="px-4 pt-4">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 xl:flex-row xl:space-x-4">
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->fathersname}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 md:mb-4 focus:outline-none dark:bg-gray-400 focus:shadow-outline focus:border-blue-200 uppercase"  id="fathersname" name="fathersname" >
                    @error('fathersname')
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->mothersname}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 md:mb-4 focus:outline-none dark:bg-gray-400 focus:shadow-outline focus:border-blue-200 uppercase" id="mothersname" name="mothersname">
                    @error('mothersname')
            ...
            <div class="form-item w-full">
                ...
                <textarea type="text"  class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 focus:outline-none dark:bg-gray-400 focus:shadow-outline focus:border-blue-200 uppercase" id="address" name="address">{{$data->address}}</textarea>
                @error('address')
