...
class ThirdquarterseniorController extends Controller
{
    ...
    public function updateThirdquarterSenior(Request $request){
        ...
        $grade->average3 = number_format(($grade->oral3 + $grade->reading3 + $grade->komunikasyon3 + $grade->pagbasa3 + $grade->century3 + $grade->contemporary3 + $grade->media3 + $grade->math3 + $grade->statistics3 + $grade->earth3 + $grade->science3 + $grade->philosophy3 + $grade->health3 + $grade->personal3 + $grade->culture3  )/15);
        $grade->save();
