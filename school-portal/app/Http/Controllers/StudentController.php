    ...
    public function deleteStudent($user_id)
{
    ...
    public function updateStudent(Request $request){
        ...
        if($request->grade === '11' || $request->grade === '12' ){
            Firstquarter::where('user_id', $data->user_id)->delete();
            Secondquarter::where('user_id', $data->user_id)->delete();
            Thirdquarter::where('user_id', $data->user_id)->delete();
            Fourthquarter::where('user_id',$data->user_id)->delete();
            $sen1->save();
            $sen2->save();
            $sen3->save();
            $sen4->save();
            ...
            Firstquartersenior::where('user_id', $data->user_id)->delete();
            Secondquartersenior::where('user_id', $data->user_id)->delete();
            Thirdquartersenior::where('user_id', $data->user_id)->delete();
            Fourthquartersenior::where('user_id', $data->user_id)->delete();
            $first->save();
            $second->save();
            $third->save();
            $fourth->save();
