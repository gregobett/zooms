...
<section class="w-full bg-[#012560] dark:bg-[#222738] border-y-2 dark:border-gray-500 py-5 bg-opacity-90">
    {{-- <h1 class="text-1xl md:text-3xl font-light text-sky-50 text-center py-5">Announcement</h1> --}}
    
    <div    x-data="{ activeSlide: 1, slides: [1, 2, 3, 4, 5] }"
        ...
        <div class="relative ">
            ...
            x-transition:enter.duration.300ms>
            <!-- Slide -->
                <img src='/images/pic6.webp' class="relative block w-full h-96 object-cover rounded-md" alt="carousel_img">
            </div>
