...
<div class="w-full  shadow-2xl rounded my-24 overflow-hidden">
    ...
    <div class="grid grid-cols-12 bg-white dark:bg-dark-eval-1">
      ...
      <div class="col-span-12 w-full px-3 py-6 justify-center flex space-x-4 border-b border-solid md:space-x-0 dark:border-none md:space-y-4 md:flex-col md:col-span-2 md:justify-start ">
            ...
            <label class=" flex uppercase tracking-wide text-gray-700 dark:text-white text-xs h-1" for="photo">
                Add Photo
            </label>
       
            <div class=" border-3 rounded-md lg:border-2 bg-gre dark:border-none">
                <label>
                    <input type="file" class=" w-full text-md text-grey-500 p-2 text-gre
                    file:mr-5 pl-2 file:py-1 file:px-2 file:lg:px-14 lg:pl-6
                    ...
                    hover:bg-blue-700" id="photo" name="photo" required>
                </label>
                </div>

        <button type='submit' class="bg-gre hover:bg-blue-700 text-md text-slate-50 border-gray-200 rounded py-2 px-10 shadow-lg">
            Save
        </button>
        ...
        <div class="px-4 pt-4">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{old('section')}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="section" name="section" capitalize>
                    @error('section')
