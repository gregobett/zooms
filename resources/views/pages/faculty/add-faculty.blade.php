      ...
      <div class="col-span-12 w-full px-3 py-6 justify-center flex space-x-4 border-b border-solid md:space-x-0 md:space-y-4 dark:border-none md:flex-col md:col-span-2 md:justify-start ">
            ...
            <div class=" rounded-md bg-gre ">
                <label>
                    ...
                    hover:file:cursor-pointer hover:bg-blue-700
                    hover:file:text-sky-200 hover:file:bg-blue-700" id="photo" name="photo" required/>
                </label>
                </div>

        <button type="submit" class="bg-gre hover:bg-blue-700 text-slate-50 border-gray-200 rounded py-2 px-10 shadow-lg">
            Save
        </button>
        ...
        <div class="px-4 pt-4">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{old('lastname')}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2  mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="lastname" name="lastname">
                    @error('lastname')
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{Auth::user()->email}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="email" name="email" disabled>
                    @error('email')
