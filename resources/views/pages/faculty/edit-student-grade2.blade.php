      ...
      <form action="{{url('update-secondquarter')}}" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" value="{{ $data->user_id }}" name="user_id" />
          ...
          <div class="flex flex-col mb-2">
              ...
              <input value="{{$data->mothertongue}}" class="border py-0 px-3 text-grey-800" type="text" name="mothertongue" id="mothertongue" >
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="filipino">Filipino</label>
              <input value="{{$data->filipino}}" class="border py-0 px-3 text-grey-800" type="text" name="filipino" id="filipino">
          </div>
          <div class="flex flex-col mb-2">
              <label class="  text-sm text-gray-900" for="english">English</label>
              <input value="{{$data->english}}" class="border py-0 px-3 text-grey-800" type="text" name="english" id="english">
          </div>
          <div class="flex flex-col mb-2">
              <label class=" text-sm text-gray-900" for="mathematics">Mathematics</label>
              <input value="{{$data->mathematics}}" class="border py-0 px-3 text-grey-800" type="text" name="mathematics" id="mathematics">
          </div>
          <div class="flex flex-col mb-2">
          ...
          <div class="flex flex-col mb-2">
            ...
            <input value="{{$data->ap}}" class="border py-0 px-3 text-grey-800" type="text" name="ap" id="ap">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="esp">Edukasyon sa Pagpapalkatao</label>
            <input value="{{$data->esp}}" class="border py-0 px-3 text-grey-800" type="text" name="esp" id="esp">
        </div>
        <div class="flex flex-col mb-2">
            <label class="  text-sm text-gray-900" for="music">Music</label>
            <input value="{{$data->music}}" class="border py-0 px-3 text-grey-800" type="text" name="music" id="music">
        </div>
        <div class="flex flex-col mb-2">
            <label class=" text-sm text-gray-900" for="arts">Arts</label>
            <input value="{{$data->arts}}" class="border py-0 px-3 text-grey-800" type="text" name="arts" id="arts">
        </div>
        <div class="flex flex-col mb-2">
            <label class="text-sm text-gray-900" for="pe">Physical Educataion</label>
            <input value="{{$data->pe}}" class="border py-0 px-3 text-grey-800" type="text" name="pe" id="pe">
        </div>

        <div class="flex flex-col mb-2">
          <label class="  text-sm text-gray-900" for="health">Health</label>
          <input value="{{$data->health}}" class="border py-0 px-3 text-grey-800" type="text" name="health" id="health">
      </div>
      <div class="flex flex-col mb-2">
          <label class=" text-sm text-gray-900" for="epp">Edukasyon Pantahanan at Pangkabuhayan</label>
          <input value="{{$data->epp}}" class="border py-0 px-3 text-grey-800" type="text" name="epp" id="epp">
      </div>
      <div class="flex flex-col mb-2">
          <label class="text-sm text-gray-900" for="tle">Technology and Livelihood Education</label>
          <input value="{{$data->tle}}" class="border py-0 px-3 text-grey-800 mb-2" type="text" name="tle" id="tle">
      </div>
